...
<meta charset="UTF-8">
    ...
    <meta name="description" content="{{$business->meta_description}}">
     @if(isset($is_slug))
    <link rel="stylesheet" href="{{asset('assets/theme9/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/theme9/modal/bootstrap.min.css')}}">
    <script src="{{asset('assets/theme9/modal/jquery.min.js')}}"></script>
    <script src="{{asset('assets/theme9/modal/bootstrap.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('assets/theme9/fontawesome-free/css/all.min.css')}}">
    @endif
    <link rel="stylesheet" href="{{asset('assets/theme9/css/styles/'.$business->theme_color.'/style.css')}}">
</head>
<body>
    <div class="wrapper">
        <div class="vCard">
            <div class="vCard-header">
                <div class="theme-bg overflow-hidden">
                    ...
                    <div class="card-detail p-0">
                        <div class="card-contact pt-0">
                            <div class="text-center card-business-hours d-flex align-items-center justify-content-between ">
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme9/icon/save.svg')}}" alt="folder" class="img-fluid">
                                        <h4 class="text-white">Save card</h4>
                                    </button>
                                </div>
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme9/icon/signout.svg')}}" alt="signout" class="img-fluid">
                                        <h4 class="">Share card</h4>
                                    </button>
                                </div>
                            </div>
                            <div class="vcard-description ">
                    ...
                    <div class="card-contact pt-3 services-div">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="services_{{$service_row_no}}">
                                        <div class="service-card">
                                            <div class="service-card-img">
                                                <img id="{{'s_image'.$image_count.'_preview'}}"  src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('assets/theme9/icon/image.svg') }}" alt="image" class="img-fluid">
                                            </div>
                    ...
                    <div class="card-contact w-100 d-inline-block pt-3">
                        <div class="scan_me_main_section">
                            <div class="scan_me_section">
                                <div class="contact-text">
                                    <h3 class="">{{__('Scan me')}}</h3>
                                </div>
                                <div class="make-an-appointment w-100 d-flex">
                                    <button type="button" class="border-dark make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 bg-transparent" data-toggle="modal" data-target="#myModal">
                                        <img src="{{asset('assets/theme9/icon/signout.svg')}}" alt="signout" class="img-fluid">
                                        <h4 class="">{{__('Share card')}}</h4>
                                    </button>
                                </div>
                            </div>
                            <div class="qr_code">
                            <div class="qr_code-main qrcode2">
                                ...
                                <div class="make-an-appointment d-flex w-100 p-0">
                                    <div class="make-an-appointment-btn">
                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                            ...
                                            <img src="{{asset('assets/theme9/icon/calender-black.svg')}}" alt="calender-black"
                                                class="img-fluid">
                                            <h4 class="text-white">{{__('Make an appointment')}}</h4>
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="card-contact">
                        ...
                        <div class="text-left contact_informations">
                    ...
                    <div class="card-contact business-hour-bg business-hours-div">
                        <div class="card-contact-header">
                            <ul>
                                <li class="d-flex align-items-center justify-content-start">
                                    <div class="contact-text">
                        ...
                        <div class="card-business-hours pb-0">
                            <ul>
                                ...
                                <li>
                                    <p>{{$day}} :
                                        <span class="days_{{$k}}"> @if(isset($business_hours->$k) && $business_hours->$k->days=='on')
                    ...
                    <div class="social-icon social-div">
                        <div class="text-center card-business-hours res-pt-0e">
                            <div class="social-icon-main w-100 align-items-center justify-content-center">
                                <div class="container-lg">
                                    <div class="row justify-content-center inputrow_socials_preview">
                                        ...
                                        @foreach($social_val as $social_key1 => $social_val1)            
                                            ...
                                            <div class="col-1 p-0 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                <div class="social-image-icon">
                                                    <a href="{{$social_val1}}">
                                                        <img src="{{asset('assets/theme9/icon/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                            class="img-fluid">
                                                    </a>
                                                </div>
                                            </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('assets/theme9/icon/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center" data-dismiss="modal">
                            <img src="{{asset('assets/theme9/img/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('assets/theme9/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('assets/theme9/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('assets/theme9/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('assets/theme9/icon/right-bottom.svg')}}" alt="right-bottom"
                        ...
                        <div class="share-card-btn">
                            <button type="button" class="share-card-btn-main">
                                <img src="{{asset('assets/theme9/img/signout.svg')}}" alt="signout" class="img-fluid">
                                {{__('Share our card')}}
                            </button>
                        </div>
                                            ...
                                            @foreach($social_val as $social_key1 => $social_val1)
                                                ...
                                                <div class="col-1 p-0 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                    <div class="image-icon">
                                                        <a href="{{$social_val1}}">
                                                            <img src="{{asset('assets/theme9/icon/modal/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                                class="img-fluid">
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('.qrcode2').qrcode({width: 120,height: 120,text: url_link});
