...
<head>
    ...
    @if(isset($is_slug))
    <link rel="stylesheet" href="{{ asset('assets/theme1/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{asset('assets/theme1/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/theme1/modal/bootstrap.min.css')}}">
    <script src="{{asset('assets/theme1/modal/jquery.min.js')}}"></script>
    <script src="{{asset('assets/theme1/modal/bootstrap.min.js')}}"></script>
    @endif
    <link rel="stylesheet" href="{{asset('assets/theme1/css/styles/'.$business->theme_color.'/style.css')}}">
</head>
            ...
            <div class="vCard-header">
                <div class="bg-white overflow-hidden">
                    ...
                    <div class="card-detail">
                        <div class="p-2 text-center vcard-description">
                                            ...
                                            @if($key1 != 'id')
                                                <li class="d-flex align-items-center justify-content-center" id="contact_{{$loop->parent->index+1}}">
                                                    <div class="image-icon">
                                                        <img src="{{asset('assets/theme1/icon/'.$color.'/'.strtolower($key1).'.svg')}}" alt="{{$val1}}" class="img-fluid">
                                                    </div>
                    ...
                    <div class="card-detail" id="business-hours-div">
                        <div class="text-center card-business-hours">
                            <div class="business-hours-image image-icon contact-icon">
                                <img src="{{asset('assets/theme1/icon/'.$color.'/clock.svg')}}" alt="clock" class="img-fluid">
                            </div>
                            ...
                            <div class="card-detail card-business-date" id="appointment-div">
                                <div class="text-center card-business-hours ">
                                    <div class="image-icon contact-icon">
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/calendar.svg')}}" alt="calendar" class="img-fluid">
                                    </div>
                                    ...
                                    <form action="" class="datepicker-form">
                                        ...
                                        <div class="make-an-appointment d-flex">
                                            ...
                                            <div class="make-an-appointment-btn">
                                                 <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 appointmentModal" data-target="#appointmentModal"  data-toggle="modal">
                            ...
                            <div class="card-detail card-business-date" id="services-div">
                                <div class="text-center card-business-hours">
                                    <div class="image-icon contact-icon">
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/phone.svg')}}" alt="phone" class="img-fluid">
                                    </div>
                                            ...
                                            <div class="col-lg-6" id="services_{{$service_row_no}}">
                                                <div class="service-card">
                                                    <div class="service-card-img">
                                                        <img id="{{'s_image'.$image_count.'_preview'}}"  src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('assets/theme1/icon/image.svg') }}" alt="image" class="img-fluid">
                                                    </div>
                    ...
                    <div class="card-detail card-business-date">
                        <div class="text-center card-business-hours">
                            <div class="image-icon contact-icon">
                                <img src="{{asset('assets/theme1/icon/'.$color.'/bookmark.svg')}}" alt="bookmark" class="img-fluid">
                            </div>
                            ...
                            <div class="make-an-appointment d-flex mb-3">
                                <div class="w-100">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/folder.svg')}}" alt="folder" class="img-fluid">
                                        <h4><a href="{{ route('bussiness.save',$business->slug)}}">Save card</a></h4>
                                    </button>
                                </div>
                            </div>
                            <div class="make-an-appointment d-flex mb-3">
                                <div class="w-100">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/signout.svg')}}" alt="signout" class="img-fluid">
                            ...
                            <div class="card-detail card-business-date mb-2" id="testimonials-div">
                                <div class="text-center card-business-hours pb-0">
                                    <div class="image-icon contact-icon">
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/user.svg')}}" alt="user" class="img-fluid">
                                    </div>
                            ...
                            <div class="social-icon mb-2 social-div" id="social-div">
                                <div class="text-center card-business-hours pb-20">
                                    <div class="image-icon contact-icon">
                                        <img src="{{asset('assets/theme1/icon/'.$color.'/share.svg')}}" alt="share" class="img-fluid">
                                    </div>
                                                    ...
                                                    <div class="col-2 {{'socials_'.$social_no}}">
                                                        <span id="{{'socials_'.$social_no}}">
                                                            <a href="{{url($social_val1)}}" id="{{'social_link_'.$social_no.'_href_preview'}}" class="{{'social_link_'.$social_no.'_href_preview'}}" target="_blank">
                                                                <div class="image-icon">
                                                                    <img src="{{asset('assets/theme1/icon/'.$color.'/'.strtolower($social_key1).'.svg')}}" alt="twitter" class="img-fluid">
                                                                </div>
                                                            </a>
                                                        </span>
                                                  </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                            ...
                            <button type="button" class="back-btn d-flex align-items-center justify-content-center" data-dismiss="modal">
                                <img src="{{asset('assets/theme1/img/back.svg')}}" alt="back" class="img-fluid">
                            </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('assets/img/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('assets/img/left-bottom.svg')}}" alt="left-bottom" class="img-fluid left-bottom-border">
                                <img src="{{asset('assets/img/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('assets/img/right-bottom.svg')}}" alt="right-bottom" class="img-fluid right-bottom-border">
                            </div>
                                                        ...
                                                        <div class="col-2 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                            <span>
                                                                <a href="{{url($social_val1)}}" class="social_link_{{$loop->parent->index+1}}_href_preview'}}" id="social_link_{{$loop->parent->index+1}}_href_preview"  target="_blank">
                                                                    <div class="image-icon">
                                                                        <img src="{{asset('assets/theme1/icon/'.$color.'/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}" class="img-fluid">
                                                                    </div>
                                                                </a>
                                                            </span>
                                                        </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        data-dismiss="modal">
                            <img src="{{asset('assets/theme1/icon/'.$color.'/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
                <div class="modal-body px-4">
                    <form class="appointment-form">
                      ...
                      <div class="form-group">
                       ...
                       <input type="email" name="email" placeholder="Enter your email" class="form-control app_email" id="recipient-name">
                       <div class="">
