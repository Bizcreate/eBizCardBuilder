...
<meta charset="UTF-8">
    ...
    @if(isset($is_slug))
    <link rel="stylesheet" href="{{asset('assets/theme4/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/theme4/modal/bootstrap.min.css')}}">
    <script src="{{asset('assets/theme4/modal/jquery.min.js')}}"></script>
    <script src="{{asset('assets/theme4/modal/bootstrap.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('assets/theme4/fontawesome-free/css/all.min.css')}}">
    @endif
    <link rel="stylesheet" href="{{asset('assets/theme4/css/styles/'.$business->theme_color.'/style.css')}}">
</head>
<body>
    <div class="wrapper">
        <div class="vCard">
            <div class="vCard-header">
                <div class="bg-white overflow-hidden">
                            ...
                            <div
                                ...
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme4/icon/save.svg')}}" alt="folder" class="img-fluid">
                                        <h4>{{__('Save card')}}</h4>
                                    </button>
                                </div>
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme4/icon/share.svg')}}" alt="signout" class="img-fluid">
                                                    ...
                                                    <div class="col-2 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                        <div class="social-image-icon">
                                                            <a href="{{$social_val1}}" target="_blank">
                                                                <img src="{{asset('assets/theme4/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                                    class="img-fluid">
                                                            </a>
                                                        </div>
                                                    </div>
                        ...
                        <div class="text-center card-business-hours">
                            <form action="" class="datepicker-form">
                                <div class="date-click d-flex w-50 float-left">
                                    <div class="pr-4">
                                        ...
                                        <div class="radio-custom date-input">
                                            <div class="">
                                                <input type="text" id="input_from" class="text-center app_date"
                                ...
                                <div class="w-50 float-left dropdown time-dropdown-sec category-dropdown-main"
                                    ...
                                    <ul class="dropdown-menu time-dropdown-menu" style="display: none;">
                                ...
                                <div class="make-an-appointment d-flex w-100 p-0">
                                    <div class="make-an-appointment-btn">
                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                            ...
                                            <img src="{{asset('assets/icon/calender-black.svg')}}" alt="calender-black"
                                                class="img-fluid">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"  id="services_{{$service_row_no}}">
                                    <div class="service-card">
                                        <div class="service-card-img">
                                            <img src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('assets/theme4/icon/image.svg') }}"  id="{{'s_image'.$image_count.'_preview'}}" alt="image" class="img-fluid">
                                        </div>
                    ...
                    <div class="card-contact business-hours-div">
                        <div class="card-contact-header">
                            <ul>
                                <li class="d-flex align-items-center justify-content-center">
                                    <div class="contact-text">
                                ...
                                @foreach($contactinfo_content as $key => $val)
                                    @foreach($val as $key1 => $val1)
                                        @if($key1 !== 'id')
                                            ...
                                            @endif
                                            @if($key1 != 'id')
                                                <li class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center" id="contact_{{$loop->parent->index+1}}">
                                                    <div class="image-icon">
                                                        <img src="{{asset('assets/theme4/icon/'.$color.'/contact/'.strtolower($key1).'.svg')}}" alt="{{$key1}}" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                        <a href="{{$href}}">
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('assets/theme4/icon/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center" data-dismiss="modal">
                            <img src="{{asset('assets/theme4/img/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{__('Share this card')}}</h4>
                        <button type="button" class="logout-btn">
                            <img src="{{asset('assets/theme4/icon/signout.svg')}}" alt="signout" class="img-fluid">
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('assets/theme4/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('assets/theme4/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('assets/theme4/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('assets/theme4/icon/right-bottom.svg')}}" alt="right-bottom"
                        ...
                        <div class="share-card-btn">
                            <button type="button" class="share-card-btn-main">
                                <img src="{{asset('assets/theme4/img/signout.svg')}}" alt="signout" class="img-fluid">
                                {{__('Share our card')}}
                            </button>
                        </div>
                        <div class="text">
                        ...
                        <div class="social-icon-section modal-social-icon-section">
                            <div class="text-center social-icon card-business-hours pb-20">
                                <div class="container-lg">
                                    <div class="row justify-content-center">
                                        ...
                                        @foreach($social_val as $social_key1 => $social_val1)
                                              ...
                                              <div class="col-1 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                  <div class="image-icon">
                                                      <a href="{{$social_val1}}">
                                                          <img src="{{asset('assets/theme4/icon/'.$color.'/contact/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                              class="img-fluid">
                                                      </a>
                                                  </div>
                                              </div>
