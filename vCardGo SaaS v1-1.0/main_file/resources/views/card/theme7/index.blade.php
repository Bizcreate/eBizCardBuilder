...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{asset('assets/theme7/fontawesome-free/css/all.min.css')}}">
    @endif
    <link rel="stylesheet" href="{{asset('assets/theme7/css/styles/'.$business->theme_color.'/style.css')}}">
</head>
<body>
    <div class="wrapper">
        <div class="vCard">
            <div class="vCard-header">
                <div class="bg-white overflow-hidden">
                                        ...
                                        @if($contactinfo['is_enabled'] == '1')
                                            @foreach($contactinfo_content as $key => $val)
                                                @foreach($val as $key1 => $val1)
                                                    ...
                                                    @endif
                                                    @if($key1 != 'id')
                                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" id="contact_{{$loop->parent->index+1}}">
                                                        <div class="image-icon">
                                                            <img src="{{asset('assets/theme7/icon/'.$color.'/contact/'.strtolower($key1).'.svg')}}" alt="{{$key1}}" class="img-fluid">
                                                        </div>
                            ...
                            <div
                                ...
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme7/icon/save.svg')}}" alt="folder" class="img-fluid">
                                        <h4>{{__('Save card')}}</h4>
                                    </button>
                                </div>
                                <div class="make-an-appointment d-flex">
                                    <button type="button"
                                        ...
                                        <img src="{{asset('assets/theme7/icon/share.svg')}}" alt="signout" class="img-fluid">
                                        <h4 class="primary-text">{{__('Share card')}}</h4>
                                    </button>
                                </div>
                            </div>
                            <div class="pt-5 pb-0 text-center vcard-description">
                                ...
                                <div class="make-an-appointment d-flex w-100 p-0">
                                    <div class="make-an-appointment-btn">
                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                            ...
                                            <img src="{{asset('assets/theme7/icon/calender-black.png')}}" alt="calender-black"
                                                class="img-fluid">
                    ...
                    <div class="card-contact card-contact-shadow testimonials-div">
                        <div class="">
                            <ul>
                                <li class="d-flex align-items-center justify-content-center">
                                    <div class="contact-text">
                    ...
                    <div class="card-contact card-contact-shadow services-div">
                        <div class="">
                            <ul>
                                <li class="d-flex align-items-center justify-content-center">
                                    <div class="contact-text">
                                    ...
                                    @php $image_count = 0; @endphp
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  id="services_{{$service_row_no}}">
                                            <div class="service-card card-contact-shadow mb-0 mt-3">
                                                <div class="service-card-img">
                                                    <img src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('assets/theme7/icon/image.svg') }}"  id="{{'s_image'.$image_count.'_preview'}}" alt="image" class="img-fluid">
                                                </div>
                                            ...
                                            <div class="col-2 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                <div class="social-image-icon">
                                                    <a href="{{$social_val1}}" target="_blank">
                                                        <img src="{{asset('assets/theme7/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                            class="img-fluid">
                                                    </a>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('assets/theme7/img/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('assets/theme7/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('assets/theme7/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('assets/theme7/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('assets/theme7/icon/right-bottom.svg')}}" alt="right-bottom"
                        ...
                        <div class="share-card-btn">
                            <button type="button" class="share-card-btn-main">
                                <img src="{{asset('assets/theme7/img/signout.svg')}}" alt="signout" class="img-fluid">
                                {{__('Share our card')}}
                            </button>
                        </div>
                                            ...
                                            @foreach($social_content as $social_key => $social_val)
                                              @foreach($social_val as $social_key1 => $social_val1)
                                                    ...
                                                    <div class="col-2 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                        <div class="image-icon">
                                                            <a href="{{$social_val1}}" target="_blank">
                                                                <img src="{{asset('assets/theme7/icon/'.$color.'/modal/'.strtolower($social_key1).'.svg')}}" alt="twitter"
                                                                    class="img-fluid">
                                                            </a>
                                                        </div>
                                                    </div>
