...
<meta charset="UTF-8">
    ...
    <meta name="description" content="{{$business->meta_description}}">
     @if(isset($is_slug))
    <link rel="stylesheet" href="{{asset('assets/theme8/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/theme8/modal/bootstrap.min.css')}}">
    <script src="{{asset('assets/theme8/modal/jquery.min.js')}}"></script>
    <script src="{{asset('assets/theme8/modal/bootstrap.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('assets/theme8/fontawesome-free/css/all.min.css')}}">
    @endif
    <link rel="stylesheet" href="{{asset('assets/theme8/css/styles/'.$business->theme_color.'/style.css')}}">
</head>
<body>
    <div class="wrapper">
        <div class="vCard">
            <div class="vCard-header">
                <div class="bg-white overflow-hidden">
                    <div class="banner-image">
                        <div class="media align-items-center justify-content-center profile-head">
                            <div class="profile-qr-code text-center">
                                <img src="{{ isset($business->logo) && !empty($business->logo) ? asset(Storage::url('card_logo/'.$business->logo)) : asset('assets/img/logo-placeholder-image-2.png') }}" id="logo_preview" alt="user" class="img-thumbnail" width="30%">
                            </div>
                        </div>
                                    ...
                                    @foreach($contactinfo_content as $key => $val)
                                        ...
                                        @endif
                                            ...
                                            <li class="" id="contact_{{$loop->parent->index+1}}">
                                                <a href="{{$href}}">
                                                    <img src="{{asset('assets/theme8/icon/'.$color.'/contact/'.strtolower($key1).'.svg')}}" alt="{{$key1}}" class="img-fluid">
                                                    <span>{{__($key1)}}</span>
                                                </a>
                                            </li>
                                            @endif
                    ...
                    <div class="card-contact p-0 social-div">
                        <ul class="contact-name inputrow_socials_preview" >
                            ...
                            @foreach($social_val as $social_key1 => $social_val1)
                                @if($social_key1  != 'id')
                                <li class="d-flex align-items-center justify-content-start  socials_{{$loop->parent->index+1}}" >
                                    <div class="left-section">
                                        <div class="left-images">
                                            <img src="{{asset('assets/theme8/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}" class="img-fluid">
                                        </div>
                                    </div>
                    ...
                    <div class="card-contact p-0">
                        <ul class="contact-name">
                            <li class="d-flex align-items-center justify-content-start">
                                ...
                                <div class="text-center card-business-hours d-flex align-items-center justify-content-between two-btns">
                                    <div class="make-an-appointment d-flex">
                                        <button type="button" class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100"  onclick="location.href = '{{route('bussiness.save',$business->slug)}}'">
                                            <img src="{{asset('assets/theme8/icon/folder.svg')}}" alt="folder" class="img-fluid">
                                            <h4>{{__('Save card')}}</h4>
                                        </button>
                                    </div>
                                    <div class="make-an-appointment d-flex">
                                        <button type="button" class="border-dark make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 bg-white" data-toggle="modal" data-target="#myModal">
                                            <img src="{{asset('assets/theme8/icon/color/signout.png')}}" alt="signout" class="img-fluid">
                    ...
                    <div class="card-contact card-contact-shadow">
                        <div class="card-contact-header  appointment-div">
                            <ul>
                        ...
                        <div class="text-center card-business-hours  appointment-div">
                                ...
                                <div class="date-click d-flex w-50 float-left">
                                    <div class="pr-4">
                                        ...
                                        <div class="radio-custom date-input">
                                            <div class="">
                                                <input type="text" id="input_from" class="text-center" placeholder="{{__('Pick a Date')}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="make-an-appointment d-flex w-100 p-0">
                                    <div class="make-an-appointment-btn">
                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                            ...
                                            <img src="{{asset('assets/theme8/icon/calender.png')}}" alt="calender-black"
                                                class="img-fluid">
                        ...
                        <div class="card-contact pt-5 px-0 pb-0 services-div">
                            <div class="pt-5 pb-3">
                                <ul>
                            ...
                            <div class="card-contact pt-4 pb-0 px-0 services-div">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  id="services_{{$service_row_no}}">
                                            <div class="service-card">
                                                <div class="service-card-img">
                                                    <img src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('assets/theme8/icon/image.svg') }}"  id="{{'s_image'.$image_count.'_preview'}}" alt="image" class="img-fluid">
                                                </div>
                    ...
                    <div class="card-contact pb-0 testimonials-div">
                        <div class="">
                            <ul>
                                <li class="d-flex align-items-center justify-content-center m-0">
                                    <div class="contact-text">
                                        <h3 class="liner-color"> <span> </span> {{__('Testimonials')}}</h3>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="social-icon-section social-div">
                                                ...
                                                @foreach($social_val as $social_key1 => $social_val1)               
                                                    ...
                                                    <div class="col-2 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                        <div class="social-image-icon">
                                                            <a href="#">
                                                                <img src="{{asset('assets/theme8/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')}}" alt="twitter"
                                                                    class="img-fluid">
                                                            </a>
                                                        </div>
                                                    </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('assets/theme8/icon/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('assets/theme8/icon/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{__('Share this card')}}</h4>
                        <button type="button" class="logout-btn">
                            <img src="{{asset('assets/theme8/icon/white/share-white.svg')}}" alt="signout" class="img-fluid">
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('assets/theme8/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('assets/theme8/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('assets/theme8/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('assets/theme8/icon/right-bottom.svg')}}" alt="right-bottom"
                        ...
                        <div class="share-card-btn">
                            <button type="button" class="share-card-btn-main">
                                <img src="{{asset('assets/theme8/icon/signout.svg')}}" alt="signout" class="img-fluid">
                                {{__('Share our card')}}
                            </button>
                        </div>
                                    ...
                                    <div class="row inputrow_socials_preview justify-content-center">
                                        <!-- <div class="social-icon w-100 d-flex align-items-center justify-content-center "> -->
                                            @foreach($social_content as $social_key => $social_val)
                                              @foreach($social_val as $social_key1 => $social_val1)
                                                    @if($social_key1  != 'id')
                                                    <div class="col-1 p-0 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                        <div class="image-icon">
                                                            <a href="#">
                                                                <img src="{{asset('assets/theme8/icon/'.$color.'/modal/'.strtolower($social_key1).'.svg')}}" alt="twitter"
                                                                    class="img-fluid">
                                                            </a>
                                                        </div>
                                                    </div>
