                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card setting-logo-box">
                                    <div class="logo-content">
                                        <img src="{{$logo.'/logo/logo.png'}}" class="big-logo filter" alt=""/>
                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card setting-logo-box">
                                    <div class="col-12">
                                        <div class="logo-content">
                                            <img src="{{$logo.'/custom_landing_page_image/landing_logo.png'}}" class="landing-logo filter  w-100" alt=""/>
                                        </div>
                                        <div class="choose-file mt-4">
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card setting-logo-box">
                                    <div class="logo-content">
                                        <img src="{{$logo.'/logo/favicon.png'}}" class="small-logo" alt=""/>
                                    </div>
