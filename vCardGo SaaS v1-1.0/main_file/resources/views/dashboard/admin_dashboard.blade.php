...
<div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{__('PAID USERS')}} : <span class="text-dark text-sm">{{$user['total_paid_user']}}</span></h5>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{__('Total Order Amount')}} : <span class="text-dark text-sm">{{$user['total_orders_price']}}</span></h5>
                </div>
            </div>
            <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
        </div>
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{__('Most Purchase Plan')}} : <span class="text-dark text-sm">{{$user['most_purchese_plan']}}</span></h5>
                </div>
            </div>
            <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
        </div>
